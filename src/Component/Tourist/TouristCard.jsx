...
const TouristCard = ({ tspot }) => {
    ...
    return (
        <div>
            <div className="my-20">
                <div className="card w-96 bg-base-100 shadow-xl text-white font-bold border-2 border-black">
                    <div className="bg-gray-800 shadow-xl rounded-2xl px-2 py-3 border-2 border-black">
                        ...
                        <div className="card-actions flex justify-center gap-2 py-2">

                            <Link to="/viewDetails.jsx">
